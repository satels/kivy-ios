...
class LibffiRecipe(Recipe):
    ...
    library = {
        'iphoneos': "build/Release-{arch.sdk}/libffi.a",
        'macosx': "build/Release/ffi.dylib",
        'iphonesimulator': "build/Release-{arch.sdk}/libffi.a",
    }
    ...
    def build_arch(self, arch):
        ...
        build_args = [
            ...
            "-target", "libffi-Mac" if 'macosx' == arch.sdk else 'libffi-iOS',
            "-configuration", "Release",
        ]

        shprint(sh.xcodebuild, *build_args)
